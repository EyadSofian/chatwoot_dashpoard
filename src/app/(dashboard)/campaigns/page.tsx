...
export default function CampaignsPage() {
  ...
  const columns: Column<CampaignRow>[] = [
    ...
    { key: "sent", header: "مُرسل", render: (r) => <span className="tnum text-success">{formatNumber(r.sent)}</span> },
    { key: "failed", header: "فشل", render: (r) => <span className="tnum text-destructive">{formatNumber(r.failed)}</span> },
